...
namespace SMSBusiness.Repository.Abstract
{
    public interface ITeacherAssessmentOperation
    {
        ...
        List<Course> GetTeacherAssessmentCourse(int? TeacherId, string AcadmicClassId, string Month);
        ...
        List<TeacherAssessmentOperation> GetTeacherMonthAssessmentResultByClass(string AcadmicClassIds, int? TeacherId, string Month);
    }
}
